...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
	    ...
	    Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "34331020866", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("33443344", "33445555"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 200", "Jardim", "88914000", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Apto 300", "Centro", "88915000", cli1, c2);
